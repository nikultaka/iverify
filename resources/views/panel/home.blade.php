          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-6">
                <div class="d-md-flex mb-4">
                  <div class="mr-md-5 mb-4">
                    <h5 class="mb-1"><i class="typcn typcn-globe-outline mr-1"></i>Total Users</h5>
                    <h2 class="text-primary mb-1 font-weight-bold">{{$totalUser}}</h2>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-sm-8">
                      ...
                      <?php foreach ($recentUsers as $user) { ?>
                        <div class="d-flex justify-content-between mb-4">
                          <div class="text-secondary font-weight-medium">{{$user['name']}}</div>
                          <div class="small">{{$user['role'] ? $user['role'] : '-' }}</div>
                        </div>
                      <?php } ?>
                    </div>
                  </div>
              ...
              <div class="col-6">
                <div class="d-md-flex mb-4">
                  <div class="mr-md-5 mb-4">
                    <h5 class="mb-1"><i class="typcn typcn-archive mr-1"></i>Total Applicant</h5>
                    <h2 class="text-secondary mb-1 font-weight-bold">{{$totalApplicant}}</h2>
                  </div>
                </div>
                <?php if (isset($recentApplicant) && count($recentApplicant) > 0) { ?>
                  <div class="row">
                    <div class="col-sm-8">
                      <div class="d-flex justify-content-between mb-4">
                        <div class="font-weight-medium">Applicant Name</div>
                        <div class="font-weight-medium">ID Number</div>
                      </div>
                      <?php foreach ($recentApplicant as $applicant) { ?>
                        <div class="d-flex justify-content-between mb-4">
                          <div class="text-secondary font-weight-medium">{{$applicant['FirstName']}}</div>
                          <div class="small">{{$applicant['IDNumber'] ? $applicant['IDNumber'] : '-' }}</div>
                        </div>
                      <?php } ?>
                    </div>
                  </div>
