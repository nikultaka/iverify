    ...
    <!-- endinject -->
    <!-- plugin js for this page -->
    <script src="{{asset('themes/template/vendors/progressbar.js/progressbar.min.js')}}"></script>
    <script src="{{asset('themes/template/vendors/chart.js/Chart.min.js')}}"></script>
    <!-- End plugin js for this page -->
    <!-- Custom js for this page-->
    <script src="{{asset('themes/template/js/dashboard.js')}}"></script>
