...
<html lang="en">
  <head>
    ...
    <!-- base:css -->
    <link rel="stylesheet" href="public/themes/template/vendors/typicons.font/font/typicons.css">
    <link rel="stylesheet" href="public/themes/template/vendors/css/vendor.bundle.base.css">
    <!-- endinject --> 
    <!-- plugin css for this page -->
    <!-- End plugin css for this page -->
    <!-- inject:css -->
    <link rel="stylesheet" href="public/themes/template/css/vertical-layout-light/style.css">
    <!-- endinject -->
    <link rel="shortcut icon" href="public/themes/template/images/favicon.png" />
  </head>
  <body>
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="public/themes/template/images/faces/face4.jpg" alt="image" class="profile-pic">
                  </div>
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="public/themes/template/images/faces/face2.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content flex-grow">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="public/themes/template/images/faces/face3.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content flex-grow">
    ...
    <!-- container-scroller -->
    <!-- base:js -->
    <script src="public/themes/template/vendors/js/vendor.bundle.base.js"></script>
    <!-- endinject -->
    <!-- Plugin js for this page-->
    <!-- End plugin js for this page-->
    <!-- inject:js -->
    <script src="public/themes/template/js/off-canvas.js"></script>
    <script src="public/themes/template/js/hoverable-collapse.js"></script>
    <script src="public/themes/template/js/template.js"></script>
    <script src="public/themes/template/js/settings.js"></script>
    <script src="public/themes/template/js/todolist.js"></script>
    <!-- endinject -->
    <!-- plugin js for this page -->
    <script src="public/themes/template/vendors/progressbar.js/progressbar.min.js"></script>
    <script src="public/themes/template/vendors/chart.js/Chart.min.js"></script>
    <!-- End plugin js for this page -->
    <!-- Custom js for this page-->
    <script src="public/themes/template/js/dashboard.js"></script>
